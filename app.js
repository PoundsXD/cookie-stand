...
document.getElementById('store3item15').innerHTML = seacenter.cookiesSold[14];
...
document.getElementById('store4item15').innerHTML = capitolhill.cookiesSold[14];
...
document.getElementById('store5item15').innerHTML = alk.cookiesSold[14];
